(function () {
    ...
    const projectData = {
        ...
        kiso: {
            ...
            desc: 'E-commerce platform with a Next.js storefront and optimized user checkout flows. Features include transparent supply chain tracking and a carbon-impact calculator integrated into the shopping experience.',
            tech: ['Next.js', 'Tailwind CSS', 'Auth.js', 'Supabase', 'Stripe', 'Vercel'],
        ...
        vireo: {
            ...
            desc: 'Patient portal built with React and Node.js, featuring a compassionate UI that reduced booking abandonment by 40%. Includes real‑time appointment scheduling and secure messaging.',
            tech: ['React', 'Node.js', 'TypeScript', 'PostgreSQL', 'Tailwind CSS', 'Docker'],
